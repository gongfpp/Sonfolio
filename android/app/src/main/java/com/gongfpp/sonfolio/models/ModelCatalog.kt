...
object ModelCatalog {
    val speech = ModelArtifact("sensevoice", "手机语音识别（离线）", "speech/sense-voice-model.int8.onnx", 239233841,
    ...
    val summary = ModelArtifact("qwen-summary", "手机总结模型（离线）", "summary/qwen2.5-0.5b-instruct-q4_k_m.gguf", 491400032,
